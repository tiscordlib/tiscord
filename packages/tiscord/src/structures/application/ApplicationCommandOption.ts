import { APIApplicationCommandOption, APIApplicationCommandOptionChoice } from 'discord-api-types/v10';
...
export class ApplicationCommandOption {
    ...
    constructor(data: APIApplicationCommandOption) {
        ...
        // @ts-expect-error
        if (data.choices) this.choices = data.choices.map(e => new ApplicationCommandOptionChoice(e));
        // @ts-expect-error
