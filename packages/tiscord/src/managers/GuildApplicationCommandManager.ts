...
export class GuildApplicationCommandManager {
    ...
    async get(id: string) {
        return new ApplicationCommand(
            await this.client.rest.get(`/applications/${this.client.applicationId}/guilds/${this.guild}commands/${id}`)
        );
    }
    ...
    async delete(id: string) {
        return this.client.rest.delete(`/applications/${this.client.applicationId}/guilds/${this.guild}commands/${id}`);
    }
    ...
    async bulkEdit(commands: APIApplicationCommand[]) {
        return (
            (await this.client.rest.put(`/applications/${this.client.applicationId}/guilds/${this.guild}commands`, {
                body: commands
            })) as APIApplicationCommand[]
        ).map((e: any) => new ApplicationCommand(e));
    }
    ...
    async create(command: APIApplicationCommand) {
        return new ApplicationCommand(
            await this.client.rest.post(`/applications/${this.client.applicationId}/guilds/${this.guild}commands`, {
                body: command
            })
        );
    }
